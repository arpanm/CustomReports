...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jmd-sales.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JMDSALES_LIST actions', async () => {
    ...
    it('dispatches FETCH_JMDSALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JMDSALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JMDSALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JMDSALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JMDSALES actions', async () => {
      const expectedActions = [
        {
