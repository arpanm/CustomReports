...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jmd-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JMDUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_JMDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JMDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JMDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JMDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JMDUSER actions', async () => {
      const expectedActions = [
        {
