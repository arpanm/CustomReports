...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.report.customreport.service.EmailAlreadyUsedException ||
            ex instanceof com.report.customreport.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.report.customreport.service.InvalidPasswordException
